  ...
  return (
    <div className="relative inline-flex items-center gap-1.5">
      ...
      >
        ...
        {isHovered && (
          <div className="absolute left-0 top-6 z-50 w-64 p-3 bg-gray-950 border border-cyan-400/30 rounded-lg shadow-xl">
...
function getOpinionStyle(opinion: InvestmentOpinion) {
  switch (opinion) {
    case 'strong_buy':
      return { bg: 'bg-red-900', text: 'text-red-300', label: '강력 매수' }
    case 'buy':
      return { bg: 'bg-orange-900', text: 'text-orange-300', label: '매수' }
    case 'hold':
      return { bg: 'bg-yellow-900', text: 'text-yellow-300', label: '보유' }
    case 'sell':
      return { bg: 'bg-blue-900', text: 'text-blue-300', label: '매도' }
    case 'strong_sell':
      return { bg: 'bg-purple-900', text: 'text-purple-300', label: '강력 매도' }
    default:
      return { bg: 'bg-gray-800', text: 'text-gray-300', label: '분석 중' }
  }
}
...
function getSentimentStyle(sentiment: 'positive' | 'neutral' | 'negative') {
  switch (sentiment) {
    case 'positive':
      return { bg: 'bg-green-900/50', text: 'text-green-400', label: '긍정적' }
    case 'negative':
      return { bg: 'bg-red-900/50', text: 'text-red-400', label: '부정적' }
    default:
      return { bg: 'bg-gray-800/50', text: 'text-gray-400', label: '중립' }
  }
}
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <div className="flex items-center gap-3 mt-2 flex-wrap">
                <span className="text-gray-400 text-lg">{stock.ticker}</span>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
              ...
              {stock.debt_ratio !== undefined && stock.debt_ratio !== null && (
                <div className="bg-gray-900/90 rounded-lg p-4">
                  ...
                  <div className={`text-xl font-bold ${
                    stock.debt_ratio === 0 ? 'text-white' : stock.debt_ratio > 100 ? 'text-orange-400' : 'text-green-400'
                  }`}>
              ...
              {stock.revenue_growth_yoy !== undefined && stock.revenue_growth_yoy !== null && (
                <div className="bg-gray-900/90 rounded-lg p-4">
                  ...
                  <div className={`text-xl font-bold ${
                    stock.revenue_growth_yoy === 0 ? 'text-white' : stock.revenue_growth_yoy > 0 ? 'text-green-400' : 'text-red-400'
                  }`}>
        ...
        {viewState === 'initial' ? (
          <Card className="bg-gradient-to-br from-gray-800 to-gray-900 border-gray-700 mb-6">
            <div className="p-12 text-center">
              ...
              <h2 className="text-2xl font-bold text-white mb-3">AI 종합 분석</h2>
              ...
              {cacheStatus && (
                <div className="mb-6">
                  {cacheStatus.cache_exists && cacheStatus.ttl_seconds && cacheStatus.ttl_seconds > 0 ? (
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-yellow-900/30 border border-yellow-700/50 rounded-lg">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-blue-900/30 border border-blue-700/50 rounded-lg">
              ...
              <button
                ...
                className="px-8 py-4 bg-gradient-to-r from-cyan-600 to-blue-600 hover:from-cyan-500 hover:to-blue-500 text-white rounded-xl font-bold text-lg transition-all transform hover:scale-105 shadow-lg shadow-cyan-900/50 flex items-center gap-3 mx-auto"
              >
                <Sparkles size={22} />
                AI 상세 분석 보기
              </button>
          ...
          <Card className="bg-gray-800 border-gray-700 mb-6">
            <div className="p-12 text-center">
              <div className="animate-spin rounded-full h-12 w-12 border-b-2 border-cyan-400 mx-auto mb-4"></div>
              <p className="text-gray-300 text-lg mb-2">{statusMessage}</p>
              {generationType === 'new' && (
          ...
          <Card className="bg-gray-800 border-gray-700 mb-6">
            <div className="p-12 text-center">
              ...
              <h2 className="text-2xl font-bold text-white mb-4">분석 생성 실패</h2>
              ...
              <button
                ...
                className="px-6 py-3 bg-cyan-600 hover:bg-cyan-500 disabled:bg-gray-600 text-white rounded-lg font-semibold transition-colors flex items-center gap-2 mx-auto"
              >
          ...
          <>
            ...
            <Card className="bg-gray-800 border-gray-700 mb-6">
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4 mb-6">
                  ...
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <div className="text-sm text-gray-400 mb-1">예상가</div>
                    <div className="text-2xl font-bold text-cyan-400">
                      {displayAnalysis.summary.target_price.toLocaleString()}원
                    </div>
                  </div>
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <div className="text-sm text-gray-400 mb-1">상승/하강 여력</div>
                ...
                <div className="bg-gray-900/90 rounded-lg p-4">
                  <h3 className="text-sm text-gray-400 mb-3">핵심 투자 포인트</h3>
            ...
            <Card className="bg-gray-800 border-gray-700 mb-6">
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <h3 className="text-sm text-cyan-400 font-semibold mb-2">수익성</h3>
                    <p className="text-gray-300 text-sm">{displayAnalysis.financial_analysis.profitability}</p>
                  </div>
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <h3 className="text-sm text-cyan-400 font-semibold mb-2">성장성</h3>
                    <p className="text-gray-300 text-sm">{displayAnalysis.financial_analysis.growth}</p>
                  </div>
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <h3 className="text-sm text-cyan-400 font-semibold mb-2">안정성</h3>
                    <p className="text-gray-300 text-sm">{displayAnalysis.financial_analysis.stability}</p>
                  </div>
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <h3 className="text-sm text-cyan-400 font-semibold mb-2">밸류에이션</h3>
                    <p className="text-gray-300 text-sm">{displayAnalysis.financial_analysis.valuation}</p>
                  </div>
                </div>
              </div>
            </Card>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-6">
              ...
              <Card className="bg-gray-800 border-gray-700">
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-900/90 rounded-lg p-4">
                      <h3 className="text-sm text-cyan-400 font-semibold mb-2">추세</h3>
                      <p className="text-gray-300 text-sm">{displayAnalysis.technical_analysis.trend}</p>
                    </div>
                    <div className="bg-gray-900/90 rounded-lg p-4">
                      <h3 className="text-sm text-cyan-400 font-semibold mb-2">지지/저항</h3>
                      <p className="text-gray-300 text-sm">{displayAnalysis.technical_analysis.support_resistance}</p>
                    </div>
                    <div className="bg-gray-900/90 rounded-lg p-4">
                      <h3 className="text-sm text-cyan-400 font-semibold mb-2">지표 분석</h3>
                      <p className="text-gray-300 text-sm">{displayAnalysis.technical_analysis.indicators}</p>
                    </div>
                  </div>
                </div>
              </Card>
              ...
              <Card className="bg-gray-800 border-gray-700">
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    <div className="bg-gray-900/90 rounded-lg p-4">
                      <h3 className="text-sm text-cyan-400 font-semibold mb-2">주요 뉴스</h3>
                    ...
                    <div className="bg-gray-900/90 rounded-lg p-4">
                      <h3 className="text-sm text-cyan-400 font-semibold mb-2">영향 분석</h3>
                      <p className="text-gray-300 text-sm">{displayAnalysis.news_analysis.impact}</p>
                    </div>
                  </div>
                </div>
              </Card>
            ...
            <Card className="bg-gray-800 border-gray-700 mb-6">
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <h3 className="text-sm text-cyan-400 font-semibold mb-2">업종 트렌드</h3>
                    <p className="text-gray-300 text-sm">{displayAnalysis.industry_analysis.industry_trend}</p>
                  </div>
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <h3 className="text-sm text-cyan-400 font-semibold mb-2">경쟁 우위</h3>
                    <p className="text-gray-300 text-sm">{displayAnalysis.industry_analysis.competitive_advantage}</p>
                  </div>
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <h3 className="text-sm text-cyan-400 font-semibold mb-2">시장 지위</h3>
                    <p className="text-gray-300 text-sm">{displayAnalysis.industry_analysis.market_position}</p>
                  </div>
                </div>
              </div>
            </Card>
              ...
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  {(displayAnalysis.risk_factors || []).map((risk, idx) => (
                    <div key={idx} className="bg-red-900/20 border border-red-900/50 rounded-lg p-4">
            ...
            <Card className="bg-gray-800 border-gray-700 mb-6">
              <div className="p-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <h3 className="text-sm text-cyan-400 font-semibold mb-2">단기 (1주-1개월)</h3>
                    <p className="text-gray-300 text-sm">{displayAnalysis.investment_strategy.short_term}</p>
                  </div>
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <h3 className="text-sm text-cyan-400 font-semibold mb-2">중기 (1-3개월)</h3>
                    <p className="text-gray-300 text-sm">{displayAnalysis.investment_strategy.mid_term}</p>
                  </div>
                  <div className="bg-gray-900/90 rounded-lg p-4">
                    <h3 className="text-sm text-cyan-400 font-semibold mb-2">장기 (3개월+)</h3>
                    <p className="text-gray-300 text-sm">{displayAnalysis.investment_strategy.long_term}</p>
                  </div>
                </div>
              </div>
            </Card>
            ...
            <div className="flex items-center justify-between">
              <button
                ...
                disabled={isGenerating}
                className="px-4 py-2 bg-gray-700 hover:bg-gray-600 disabled:bg-gray-800 text-gray-300 hover:text-white rounded-lg text-sm transition-colors flex items-center gap-2"
              >
