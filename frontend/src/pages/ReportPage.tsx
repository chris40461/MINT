    ...
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-gray-600">{reportType === 'morning' ? '장 시작' : '장 마감'} 리포트 로딩 중...</p>
        </div>
      </div>
    )
  }
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      <div className="container mx-auto px-4 py-8">
        {/* Header with Filters */}
        <div className="mb-8">
          <h1 className="text-4xl font-bold text-gray-900 mb-6">AI 시장 리포트</h1>
          ...
          <div className="grid gap-4 mb-6">
            ...
            <div className="flex items-center gap-4">
              ...
              <input
                ...
                className="px-4 py-2 bg-white text-gray-900 rounded-lg border border-gray-200 focus:border-emerald-400 focus:outline-none"
              />
        ...
        {(error || !report) && (
          <Card className="bg-white border-gray-200">
            <div className="p-12 text-center">
              ...
              <h3 className="text-2xl font-bold text-gray-900 mb-2">리포트 데이터 없음</h3>
              ...
              <div className="bg-gray-50/50 rounded-lg p-4 text-left max-w-md mx-auto">
        ...
        {report && reportType === 'morning' && 'kospi_range' in report && (
          ...
          <div className="p-6">
            ...
            <div className="flex items-center justify-center gap-6 mb-6">
              <div className="flex-1 bg-red-50 border border-red-200 rounded-xl p-6 text-center">
                <div className="text-sm text-red-600 mb-2 font-semibold">하단 지지선</div>
                <div className="text-4xl font-bold text-red-600 mb-1">{report.kospi_range.low.toLocaleString()}</div>
                <div className="text-xs text-red-500">Support Level</div>
              </div>
              ...
              <div className="flex-1 bg-green-50 border border-green-200 rounded-xl p-6 text-center">
                <div className="text-sm text-green-600 mb-2 font-semibold">상단 저항선</div>
                <div className="text-4xl font-bold text-green-600 mb-1">{report.kospi_range.high.toLocaleString()}</div>
                <div className="text-xs text-green-500">Resistance Level</div>
              </div>
            </div>
            <div className="bg-gray-50/90 rounded-lg p-4">
              <div className="text-xs text-emerald-600 font-semibold mb-2">분석 근거</div>
              <p className="text-gray-700 text-sm leading-relaxed">{report.kospi_range.reasoning}</p>
            </div>
          </div>
        </Card>
        )}
          ...
          <div className="grid md:grid-cols-2 gap-6 mb-6">
            <Card className="bg-white border-gray-200">
              <div className="p-6">
                ...
                <div className="bg-gray-50/90 rounded-lg p-4 space-y-3">
              ...
              <div className="p-6">
                ...
                <div className="space-y-2">
                  {report.market_risks.map((risk: string, idx: number) => (
                    <div key={idx} className="flex items-start gap-3 bg-orange-50 border border-orange-200 rounded-lg p-3">
                      <span className="text-orange-600 font-bold text-lg">•</span>
                      <span className="text-gray-700 flex-1 text-sm">{risk}</span>
                    </div>
                  ))}
                </div>
              </div>
          ...
          <div className="grid gap-3">
            {report.top_stocks.map((stock) => {
              ...
              return (
                <Card
                  key={stock.ticker}
                  className="bg-white border-gray-200 hover:border-emerald-400 transition-all cursor-pointer"
                ...
                >
                  <div className="p-5">
                    ...
                    <div className="grid grid-cols-4 gap-3 mb-3">
                      <div className="bg-gray-50/90 rounded-lg p-3 text-center">
                        <div className="text-xs text-gray-600 mb-1">진입가</div>
                    ...
                    {/* Reason Summary */}
                    <p className="text-gray-700 text-sm leading-relaxed mb-2">{stock.reason}</p>
                      ...
                      <div className="mt-4 pt-4 border-t border-gray-200 space-y-4 animate-in fade-in slide-in-from-top-2 duration-300">
                        ...
                        {stock.entry_strategy?.analysis && (
                          <div className="bg-blue-50 border border-blue-200 rounded-lg p-4">
                            <div className="text-xs text-blue-700 font-semibold mb-2">📊 진입 판단 분석</div>
                            <div className="text-sm text-gray-700 leading-relaxed">{stock.entry_strategy.analysis}</div>
                          </div>
                        )}

                        {/* Strategy Grid */}
                        <div className="grid grid-cols-2 md:grid-cols-3 gap-4">
                          <div className="bg-gray-50/90 rounded-lg p-3">
                            <div className="text-xs text-gray-600 mb-1">진입 타이밍</div>
                            <div className="font-semibold text-gray-900 text-sm">{stock.entry_strategy.entry_timing}</div>
                          </div>
                          <div className="bg-gray-50/90 rounded-lg p-3">
                            ...
                            <div className="font-semibold text-gray-900 text-sm">{stock.entry_strategy.holding_period}</div>
                          </div>
                          <div className="bg-gray-50/90 rounded-lg p-3">
                            <div className="text-xs text-gray-600 mb-1">손익비</div>
                            <div className="font-semibold text-emerald-600">{stock.entry_strategy.risk_reward_ratio}</div>
                          </div>
                        </div>

                        {/* Price Levels */}
                        <div className="bg-gray-50/90 rounded-lg p-4 space-y-2">
                          <div className="flex justify-between items-center">
                            <span className="text-sm text-gray-600">진입가</span>
                            <span className="font-bold text-gray-900">{stock.entry_strategy.entry_price.toLocaleString()}원</span>
                          </div>
                        ...
                        <div className="space-y-3">
                          <div className="bg-gray-50/90 rounded-lg p-3">
                            <div className="text-xs text-emerald-600 font-semibold mb-1">기술적 근거</div>
                            <div className="text-sm text-gray-700 leading-relaxed">{stock.entry_strategy.technical_basis}</div>
                          </div>
                          <div className="bg-gray-50/90 rounded-lg p-3">
                            <div className="text-xs text-emerald-600 font-semibold mb-1">거래량 전략</div>
                            <div className="text-sm text-gray-700 leading-relaxed">{stock.entry_strategy.volume_strategy}</div>
                          </div>
                          <div className="bg-gray-50/90 rounded-lg p-3">
                            <div className="text-xs text-emerald-600 font-semibold mb-1">청산 조건</div>
                            <div className="text-sm text-gray-700 leading-relaxed">{stock.entry_strategy.exit_condition}</div>
                          </div>
                        </div>
                      </div>
                    )}
                    ...
                    {!isExpanded && (
                      <div className="text-center mt-3 pt-3 border-t border-gray-200">
                        <span className="text-xs text-emerald-600">클릭하여 상세 전략 보기</span>
                      </div>
                    )}
                  </div>
                </Card>
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                {report.sector_analysis.bullish.map((sector, idx) => (
                  <div key={idx} className="bg-green-50 border-l-4 border-green-400 rounded-r-lg p-4">
                    <div className="font-bold text-gray-900 mb-2 flex items-center gap-2">
                      <span className="text-green-600">▲</span>
                      {sector.sector}
                    </div>
                    <p className="text-gray-700 text-sm leading-relaxed">{sector.reason}</p>
                  </div>
                ))}
              </div>
            </div>
            ...
            <div className="p-6">
              ...
              <div className="space-y-3">
                {report.sector_analysis.bearish.map((sector, idx) => (
                  <div key={idx} className="bg-red-50 border-l-4 border-red-400 rounded-r-lg p-4">
                    <div className="font-bold text-gray-900 mb-2 flex items-center gap-2">
        ...
        {report && reportType === 'morning' && 'investment_strategy' in report && (
          <Card className="bg-white border-emerald-200 mb-6">
            <div className="p-6">
              ...
              <div className="bg-gray-50/90 rounded-lg p-5 border-l-4 border-emerald-400 space-y-3">
            ...
            <div className="p-6">
              ...
              <div className="grid gap-3">
                {Object.entries(report.daily_schedule).map(([timeKey, strategy]) => {
                  ...
                  return (
                    <div key={timeKey} className="bg-gray-50/90 rounded-lg p-4 border-l-4 border-emerald-400 hover:bg-gray-50 transition-colors">
                      <div className="flex items-start gap-4">
                        <div className="bg-emerald-100 text-emerald-700 font-mono font-bold px-3 py-1 rounded text-sm min-w-[120px] text-center">
                          {timeRange}
                        </div>
                        <p className="text-gray-700 flex-1 text-sm leading-relaxed">{strategy}</p>
                      </div>
                    </div>
                  )
                })}
        ...
        {report && reportType === 'afternoon' && 'market_summary' in report && (
          <>
              ...
              <Card className="bg-white border-gray-200">
                <div className="p-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className={`text-2xl font-bold ${report.market_summary.kospi_change >= 0 ? 'text-green-600' : 'text-red-600'}`}>
              ...
              <Card className="bg-white border-gray-200">
                <div className="p-6">
                  ...
                  <div className="text-center">
                    ...
                    <div className={`text-2xl font-bold ${report.market_summary.kosdaq_change >= 0 ? 'text-green-600' : 'text-red-600'}`}>
            ...
            <div className="grid md:grid-cols-2 gap-6 mb-6">
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex h-8 rounded-lg overflow-hidden">
                      <div
                        className="bg-green-500 flex items-center justify-center text-gray-900 text-xs font-bold"
                      ...
                      <div
                        className="bg-gray-500 flex items-center justify-center text-gray-900 text-xs font-bold"
                      ...
                      <div
                        className="bg-red-500 flex items-center justify-center text-gray-900 text-xs font-bold"
                    ...
                    <div className="grid grid-cols-3 gap-2 text-center">
                      <div className="bg-green-100 rounded-lg p-3">
                        <div className="text-green-600 font-bold text-xl">{report.market_summary.advance_count}</div>
                        <div className="text-xs text-green-500">상승</div>
                      </div>
                      <div className="bg-gray-200 rounded-lg p-3">
                        <div className="text-gray-600 font-bold text-xl">{report.market_summary.unchanged_count}</div>
                        <div className="text-xs text-gray-500">보합</div>
                      </div>
                      <div className="bg-red-100 rounded-lg p-3">
                        <div className="text-red-600 font-bold text-xl">{report.market_summary.decline_count}</div>
                        <div className="text-xs text-red-500">하락</div>
                      </div>
                    </div>
                    {/* 시장 폭 해석 */}
                    {report.market_breadth && (
                      <div className="bg-gray-50/90 rounded-lg p-3 mt-3">
                        <div className="flex items-center gap-2 mb-2">
                          <span className={`px-2 py-1 rounded text-xs font-bold ${
                            report.market_breadth.sentiment === '강세장' ? 'bg-green-100 text-green-700' :
                            report.market_breadth.sentiment === '약세장' ? 'bg-red-100 text-red-700' :
                            'bg-yellow-100 text-yellow-700'
                          }`}>
                            {report.market_breadth.sentiment}
                          </span>
                        </div>
                        <p className="text-gray-700 text-sm">{report.market_breadth.interpretation}</p>
                      </div>
                    )}
                  </div>
                </div>
              ...
              <Card className="bg-white border-gray-200">
                <div className="p-6">
                  <h3 className="text-xl font-bold text-gray-900 mb-4">거래대금</h3>
                  <div className="text-center mb-4">
                    <div className="text-4xl font-bold text-emerald-600">
                      {(report.market_summary.trading_value / 10000).toFixed(1)}
                      <span className="text-lg text-gray-600 ml-1">조원</span>
                    </div>
                  </div>
                </div>
              </Card>
              ...
              <div className="p-6">
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  ...
                  <div className="bg-gray-50/50 rounded-lg p-4">
                    <h4 className="text-lg font-bold text-emerald-600 mb-3">KOSPI</h4>
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">외국인</span>
                        <span className={`font-bold ${report.market_summary.foreign_net_kospi >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className={`font-bold ${report.market_summary.institution_net_kospi >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                      ...
                      <div className="flex justify-between items-center">
                        ...
                        <span className={`font-bold ${report.market_summary.individual_net_kospi >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                  ...
                  <div className="bg-gray-50/50 rounded-lg p-4">
                    ...
                    <div className="space-y-3">
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">외국인</span>
                        <span className={`font-bold ${report.market_summary.foreign_net_kosdaq >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                          {report.market_summary.foreign_net_kosdaq >= 0 ? '+' : ''}{report.market_summary.foreign_net_kosdaq?.toLocaleString()}억
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">기관</span>
                        <span className={`font-bold ${report.market_summary.institution_net_kosdaq >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                          {report.market_summary.institution_net_kosdaq >= 0 ? '+' : ''}{report.market_summary.institution_net_kosdaq?.toLocaleString()}억
                        </span>
                      </div>
                      <div className="flex justify-between items-center">
                        <span className="text-gray-600">개인</span>
                        <span className={`font-bold ${report.market_summary.individual_net_kosdaq >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                ...
                {report.supply_demand_analysis && (
                  <div className="bg-gray-50/90 rounded-lg p-4 mt-4 border-l-4 border-emerald-400">
                    <p className="text-gray-700 leading-relaxed">{report.supply_demand_analysis}</p>
                  </div>
                )}
              </div>
            </Card>
                      ...
                      {report.sector_analysis.bullish?.map((sector, idx) => (
                        <div key={idx} className="bg-green-50 border-l-4 border-green-400 rounded-r-lg p-4">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-green-600 font-bold">{sector.change}</span>
                          </div>
                          <p className="text-gray-700 text-sm leading-relaxed">{sector.reason}</p>
                        </div>
                      ))}
                      ...
                      {report.sector_analysis.bearish?.map((sector, idx) => (
                        <div key={idx} className="bg-red-50 border-l-4 border-red-400 rounded-r-lg p-4">
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <span className="text-red-600 font-bold">{sector.change}</span>
                          </div>
                          <p className="text-gray-700 text-sm leading-relaxed">{sector.reason}</p>
                        </div>
                      ))}
                ...
                <div className="p-6">
                  ...
                  <div className="grid gap-4">
                    {report.today_themes.map((theme, idx) => (
                      <div key={idx} className="bg-gray-50/90 rounded-lg p-4 border-l-4 border-yellow-400">
                        <div className="flex items-center gap-3 mb-2">
                          <span className="text-yellow-600 font-bold text-lg">{theme.theme}</span>
                        </div>
                        <p className="text-gray-700 text-sm mb-3">{theme.drivers}</p>
                        {theme.leading_stocks && theme.leading_stocks.length > 0 && (
                          <div className="flex flex-wrap gap-2">
                            <span className="text-xs text-gray-600">대장주:</span>
                            {theme.leading_stocks.map((stock, stockIdx) => (
                              <span key={stockIdx} className="px-2 py-1 bg-yellow-100 text-yellow-700 rounded text-xs font-medium">
                                {stock}
                              </span>
                            ))}
                          </div>
                ...
                <div className="p-6">
                  ...
                  <div className="grid gap-4">
                    {report.surge_analysis.map((stock, idx) => (
                      <div key={idx} className="bg-gray-50/90 rounded-lg p-4 hover:bg-gray-50 transition-colors">
                        <div className="flex items-start justify-between mb-3">
                          <div>
                            ...
                            {stock.change_rate && (
                              <span className={`text-sm font-bold ${stock.change_rate >= 0 ? 'text-green-600' : 'text-red-600'}`}>
                        ...
                        <div className="space-y-2">
                          <div>
                            <span className="text-xs text-emerald-600 font-semibold">급등 사유</span>
                            <p className="text-gray-700 text-sm">{stock.reason}</p>
                          </div>
                          <div>
                            <span className="text-xs text-emerald-600 font-semibold">향후 전망</span>
                            <p className="text-gray-700 text-sm">{stock.outlook}</p>
                          </div>
                        </div>
                      </div>
                    ))}
                  ...
                  <div className="space-y-2">
                    {report.check_points.map((point: string, idx: number) => (
                      <div key={idx} className="flex items-start gap-3 bg-orange-50 border border-orange-200 rounded-lg p-3">
                        ...
                        <span className="text-gray-700 flex-1 text-sm">{point}</span>
                      </div>
                    ))}
                  </div>
                </div>
